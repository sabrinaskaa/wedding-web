        ...
        <Grid item xs={8} style={{ paddingLeft: 10 }}>
          ...
          >
            {qty > 0 ? (
                ...
                {top.addons.length > 0 ? (
                  ...
                  >
                    <div className={classes.buttonAddon}>
                      {cart.filter(data => data.id === top.id).length} Item
                    </div>
                    <div className={classes.addonInfo}>
                      {intl.formatMessage({ id: "cardProduct.canCustomized" })}
                    </div>
                  </div>
                ) : (
                  <ButtonGroup
                  ...
                  >
                    <Button
                      ...
                      style={{
                        color:
                          process.env.REACT_APP_COLOR_FONT_BUTTON || "#000000",
              ...
              <div>
                {top.onStock && top.quantity >= top.minimumOrderQuantity ? (
                  <>
                    {top.addons.length > 0 ? (
                      <div
                        style={{
